...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ambulances', '0002_ambulancesauditlogentry'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('sale', '0006_auto_20160711_1526'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ambulances', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ambulances.Ambulances')),
